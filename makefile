...
SOURCES=main.c vec2.c mat3.c game.c sprite.c transform.c entity.c system.c \
	script.c test/keyboard_controlled.c test/test.c
FFI=game.h vec2.h mat3.h entity.h transform.h sprite.h test/keyboard_controlled.h
